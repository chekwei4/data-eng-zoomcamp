...
with DAG(
    ...
    # download_dataset_task >> format_to_parquet_task >> local_to_gcs_task  >> remove_temp_file_task >> bigquery_external_table_task >> move_fhv_files_task